...
@section('content')
    ...
    {!! Form::model($prueba, ['method' => 'PUT', 'route' => ['admin.pruebas.update', $prueba->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('preguntas[]', $preguntas, old('preguntas') ? old('preguntas') : $prueba->preguntas->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-preguntas' ]) !!}
                    <p class="help-block"></p>
