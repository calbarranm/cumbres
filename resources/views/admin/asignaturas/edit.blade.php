...
@section('content')
    ...
    {!! Form::model($asignatura, ['method' => 'PUT', 'route' => ['admin.asignaturas.update', $asignatura->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('profesores[]', $profesores, old('profesores') ? old('profesores') : $asignatura->profesores->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-profesores' ]) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($asignatura->imagen_asignatura)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$asignatura->imagen_asignatura) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$asignatura->imagen_asignatura) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('activo', 1, old('activo', old('activo')), []) !!}
                    <p class="help-block"></p>
